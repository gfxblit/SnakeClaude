...
eval("{__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   handleInput: () => (/* binding */ handleInput)\n/* harmony export */ });\n/* harmony import */ var _game_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./game.js */ \"./src/game.js\");\n\n\n/**\n * @file Handles player input.\n */\n\n/**\n * Sets up input handling for the game.\n * @param {object} gameState The game state to modify based on input.\n * @returns {function} A function to remove the event listener.\n */\nfunction handleInput(gameState) {\n  const handleKeyDown = (e) => {\n    switch (e.key) {\n      case 'ArrowUp':\n        if (gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.DOWN) {\n          gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.UP;\n        }\n        break;\n      case 'ArrowDown':\n        if (gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.UP) {\n          gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.DOWN;\n        }\n        break;\n      case 'ArrowLeft':\n        if (gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.RIGHT) {\n          gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.LEFT;\n        }\n        break;\n      case 'ArrowRight':\n        if (gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.LEFT) {\n          gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.RIGHT;\n        }\n        break;\n    }\n  };\n\n  document.addEventListener('keydown', handleKeyDown);\n\n  let touchStartX = 0;\n  let touchStartY = 0;\n\n  const handleTouchStart = (e) => {\n    touchStartX = e.touches[0].clientX;\n    touchStartY = e.touches[0].clientY;\n  };\n\n  const handleTouchEnd = (e) => {\n    const touchEndX = e.changedTouches[0].clientX;\n    const touchEndY = e.changedTouches[0].clientY;\n\n    const dx = touchEndX - touchStartX;\n    const dy = touchEndY - touchStartY;\n\n    if (Math.abs(dx) > Math.abs(dy)) {\n      // Horizontal swipe\n      if (dx > 0 && gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.LEFT) {\n        gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.RIGHT;\n      } else if (dx < 0 && gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.RIGHT) {\n        gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.LEFT;\n      }\n    } else {\n      // Vertical swipe\n      if (dy > 0 && gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.UP) {\n        gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.DOWN;\n      } else if (dy < 0 && gameState.snake.direction !== _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.DOWN) {\n        gameState.snake.direction = _game_js__WEBPACK_IMPORTED_MODULE_0__.Direction.UP;\n      }\n    }\n  };\n\n  document.addEventListener('touchstart', handleTouchStart);\n  document.addEventListener('touchend', handleTouchEnd);\n\n  return () => {\n    document.removeEventListener('keydown', handleKeyDown);\n    document.removeEventListener('touchstart', handleTouchStart);\n    document.removeEventListener('touchend', handleTouchEnd);\n  };\n}\n\n//# sourceURL=webpack://snakeclaude/./src/input.js?\n}");
